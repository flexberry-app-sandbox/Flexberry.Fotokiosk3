...
namespace IIS.Fotokiosk3
{
    ...
    [View("ОплатаE", new string[] {
            ...
            "СделатьФото.Цена as \'Стоимость\'"}, Hidden=new string[] {
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk3.ВидОплаты fСпособОпл;
        ...
        public virtual IIS.Fotokiosk3.ВидОплаты СпособОпл
        {
            get
            {
                ...
                IIS.Fotokiosk3.ВидОплаты result = this.fСпособОпл;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Fotokiosk3.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Fotokiosk3.Оплата));
                }
            }
        }
    }
