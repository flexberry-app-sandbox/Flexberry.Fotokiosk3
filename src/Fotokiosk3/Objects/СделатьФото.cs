...
namespace IIS.Fotokiosk3
{
    ...
    [View("СделатьФотоE", new string[] {
            ...
            "КатегорФото as \'Категор фото\'",
            "Цена as \'Цена\'"})]
    [AssociatedDetailViewAttribute("СделатьФотоE", "ДопНастройки", "ДопНастройкиE", true, "", "Доп настройки", true, new string[] {
            ""})]
    ...
    public class СделатьФото : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk3.Категория fКатегорФото;
        
        private int fЦена;
        
        private IIS.Fotokiosk3.DetailArrayOfДопНастройки fДопНастройки;
        ...
        public virtual IIS.Fotokiosk3.Категория КатегорФото
        {
            get
            {
                ...
                IIS.Fotokiosk3.Категория result = this.fКатегорФото;
        ...
        public virtual IIS.Fotokiosk3.DetailArrayOfДопНастройки ДопНастройки
        {
            get
            {
                ...
                {
                    this.fДопНастройки = new IIS.Fotokiosk3.DetailArrayOfДопНастройки(this);
                }
                IIS.Fotokiosk3.DetailArrayOfДопНастройки result = this.fДопНастройки;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СделатьФотоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СделатьФотоE", typeof(IIS.Fotokiosk3.СделатьФото));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СделатьФотоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СделатьФотоL", typeof(IIS.Fotokiosk3.СделатьФото));
                }
            }
        }
    }
