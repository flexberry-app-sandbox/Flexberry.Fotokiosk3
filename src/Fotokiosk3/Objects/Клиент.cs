...
namespace IIS.Fotokiosk3
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk3.Оплата fОплата;
        
        private IIS.Fotokiosk3.ОтправНаПочту fОтправНаПочту;
        ...
        [PropertyStorage(new string[] {
                "Оплата"})]
        [NotNull()]
        public virtual IIS.Fotokiosk3.Оплата Оплата
        {
            get
            {
                ...
                IIS.Fotokiosk3.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "ОтправНаПочту"})]
        [NotNull()]
        public virtual IIS.Fotokiosk3.ОтправНаПочту ОтправНаПочту
        {
            get
            {
                ...
                IIS.Fotokiosk3.ОтправНаПочту result = this.fОтправНаПочту;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Fotokiosk3.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Fotokiosk3.Клиент));
                }
            }
        }
    }
